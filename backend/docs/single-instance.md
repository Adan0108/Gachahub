...
| Cron jobs | `mls-key-package-cleanup`, `chat-invite-expiry`, the integrity sweep (`common/integrity`), media cleanup | run once per instance: duplicate work and duplicate Discord alerts |
